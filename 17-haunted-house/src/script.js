...
const walls = new THREE.Mesh(
    new THREE.BoxGeometry(wallsPosition.x, wallsPosition.y, wallsPosition.z),
...
walls.position.y = wallsPosition.y / 2
house.add(walls)
...
const door = new THREE.Mesh(
    new THREE.PlaneGeometry(
        doorPosition.x,
        doorPosition.y,
        100, // width segments (work with displacement map)
        100 // height segments (work with displacement map)
    ),
    new THREE.MeshStandardMaterial({
        ...
        displacementScale: 0.1, // work with displacement map
...
door.geometry.setAttribute(
    ...
    new THREE.Float32BufferAttribute(
        ...
        2 // item size: how many values represent one vertex, since it's 2d, it's 2
    )
)
...
const roof = new THREE.Mesh(
    new THREE.ConeGeometry(roofPosition.x, roofPosition.y, roofPosition.z),
    new THREE.MeshStandardMaterial({ color: '#b35f45' })
)
roof.position.y = wallsPosition.y + roofPosition.y / 2
